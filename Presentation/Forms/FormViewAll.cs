...
namespace OneKickHeroesApp
{
    public partial class FormViewAll : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string filePath = @"C:\Users\kanne\Downloads\repo\bin\Debug\Data\superheroes.txt";
        ...
        private void dgvSuperheroes_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
